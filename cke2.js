...
ClassicEditor
	.create( document.querySelector( '#editor' ), {
		plugins: [ Font, WordCount, Essentials, Paragraph, Heading, List, Bold, Italic ],
	...
	.then( editor => {
		...
		editor.model.document.on( 'change:data', () => {
			...
			if ( plainText.length > maxCharacters ) {
				...
				text = char1 + char2;
				// document.getElementById( 'char1' ).innerText = char1;
				// document.getElementById( 'char2' ).innerText = char2;
			} else {
				char1 = plainText.slice( 0, maxCharacters );
				char2 = plainText.slice( maxCharacters, plainText.length );
				text = char1 + char2;
			...
			setTimeout( () => {
		     	 editor.setData( `<span>${ char1 }</span><span style="background-color:hsl(0 , 75% , 60%)">${ char2 }</span>` );
		          	}, 100 );
